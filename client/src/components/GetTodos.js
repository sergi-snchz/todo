...
function GetTodos() {
  ...
  let todosHeader = 'flex justify-between mb-3 items-center max-w-xl';
  if (isModalOpen) {
  ...
  return (
    <div className="mt-5 w-11/12 mx-auto max-w-xl">
      ...
      {todos.map((todo, index) => {
        let classes = "flex justify-around text-sm gap-3 items-center hover:bg-gray-400 cursor-pointer";
        if (index % 2 === 0) {
          classes += " bg-gray-200";
        } else {
          classes += " bg-gray-300";
      ...
      <div className={modalClasses}>
        ...
        <form className="ml-3 mb-12" onSubmit={handleEditSubmit}>
